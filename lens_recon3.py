...
#D_T_arcmin = 27.0 #35.4 #27.0
#D_P_arcmin = 40.0*np.sqrt(2) #63.1 #40.0*np.sqrt(2)
...
output_filename = 'ideal_noise_mv2.dat'
#output_filename = 'planck_noise_mv2.dat'
#output_filename = 'alicpt_noise3.dat'
